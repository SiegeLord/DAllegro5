...
extern (C) 
{
	...
	char*             al_get_joystick_name(ALLEGRO_JOYSTICK* joystick);
	...
	char*             al_get_joystick_stick_name(in ALLEGRO_JOYSTICK* joystick, int stick);

	int               al_get_joystick_num_axes(in ALLEGRO_JOYSTICK* joystick, int stick);
	char*             al_get_joystick_axis_name(in ALLEGRO_JOYSTICK* joystick, int stick, int axis);

	int               al_get_joystick_num_buttons(in ALLEGRO_JOYSTICK* joystick);
	char*             al_get_joystick_button_name(in ALLEGRO_JOYSTICK* joystick, int buttonn);
