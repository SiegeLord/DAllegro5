      ...
      switch (event.type) {
         case ALLEGRO_EVENT_KEY_DOWN:
            switch (event.keyboard.keycode) {
               ...
               do_seek:
                  al_seek_video(video, al_get_video_position(video,
                        ALLEGRO_VIDEO_POSITION_TYPE.ALLEGRO_VIDEO_POSITION_ACTUAL) + incr);
                  break;
